...
if(isset($_SESSION['user_id'])){
    ...
    confirm($result2 = query("select * from setting where setting_id = 1"));
    $logo = mysqli_fetch_assoc($result2);
    if($row = mysqli_fetch_assoc($result)){
        $user_name = $row['name']; 
        $user_name = $row['email']; 
        $user_name = $row['phone'];
        $price = $_SESSION['item-total'];
        $displayCurrency ="INR";
                    ...
                    <div class="col-lg-5">
                        <div class="order-summary">
                            ...
                            <form action="successful.php" method="POST">
                                ...
                                <button  name="cash_on_delivery" class="btn btn-dark btn-place-order" >Cash On Delivery</button>
                            </form>
